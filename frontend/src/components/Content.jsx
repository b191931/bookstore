    ...
    <Box sx={{ display: "flex", backgroundColor: "#f4f4f4" }}>
      ...
      <AppBar position="fixed" open={open} sx={{ backgroundColor: "#4267b2" }}>
        <Toolbar>
          ...
          <Stack direction="row" spacing={2}>
            ...
            <Button color="inherit">
              <a
                href="mailto:prshanthpottola49an@gmail.com"
                style={{ textDecoration: "none", color: "white" }}
              >
                Contact
              </a>
            ...
            <div className="avatar-component">
              {login && (
                <Avatar
                  ...
                  src={
                    profilePhoto
                      ? `http://localhost:9002/uploads/${profilePhoto}`
                      : "http://localhost:9002/uploads/profile.png"
                  }
                  style={avatarStyle}
      ...
      >
        <DrawerHeader sx={{ backgroundColor: "#4267b2" }}>
          ...
          <Box sx={{ paddingRight: "8px", color: "white" }}>RGUKT BASAR</Box>
        ...
        <Router>
          <Routes>
            ...
            <Route
              ...
              element={
                <Fragment>
                  <RegisterComponent /> <ContentComponent />
                </Fragment>
              }
            />
